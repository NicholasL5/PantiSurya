...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addBalance']) && isset($_POST['removeBalance'])) {
    ...
    $newBalance = $resident['keuangan_obat'] + $addBalance - $removeBalance;

    $stmt_update_balance = $db->prepare("UPDATE penduduk SET keuangan_obat = :newBalance WHERE id = :residentId");
...
<body>
    ...
    <div>
        <script>
            ...
            window.location.href = "keuangan_obat.php";
        </script>
    </div>
    <?php endif; ?>
