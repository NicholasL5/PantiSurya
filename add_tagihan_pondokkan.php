            ...
            <div class="main">
                ...
                <div class="column">
                    ...
                    <form id="balanceForm" method="POST">
                        ...
                        <select class="form-select" aria-label="Default select example" name="ruanganData" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal-pondokkan" name="tanggal-pondokkan" required>
                        </div>
